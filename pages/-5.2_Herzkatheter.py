...
cardiac_mask = (
    df_cardiac["leadingDiagnosis"]
    .str.lower()
    .str.contains(
        "stemi|nstemi|acs|herzinfarkt|st-hebung|sthebung|akutes koronarsyndrom"
    )
)
...
if "leadingDiagnosis" in cardiac_cases.columns:
    reanimation_mask = (
        cardiac_cases["leadingDiagnosis"]
        .str.lower()
        .str.contains("reanimation|herz-kreislauf-stillstand|wiederbelebung")
    )
...
if cardiac_count > 0:
    ...
    cardiac_cases_display = cardiac_cases_sorted[
        ["protocolId", "leadingDiagnosis", "targetDestination", "hospital_eligible"]
    ]
